...
export function ForgotPassword() {
  ...
  const handleResendReset = async () => {
    ...
    setResendMsg(
      result.success
        ? 'Link reset baru telah dikirim ke email Anda.'
        : result.error || 'Gagal mengirim ulang link reset.'
    );
  };
          ...
          {view === 'form' && (
            <>
              ...
              <p className="text-ocean-500 text-sm mb-8">
                Masukkan email yang terdaftar, kami akan mengirimkan link reset kata sandi.
              </p>
